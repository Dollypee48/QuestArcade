        ...
        <div className="flex flex-col gap-10 lg:flex-row">
          <div className="flex-1 space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-sm text-foreground/70">
              <p className="font-semibold text-foreground">Perks of registering</p>
          ...
          <div className="flex-1">
            <div className="space-y-6 rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div className="relative py-2 text-center text-xs uppercase tracking-widest text-foreground/40">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full gap-2 rounded-full border-white/20 bg-white/10 py-3 text-sm font-semibold text-foreground/85 hover:bg-white/15"
                onClick={connect}
