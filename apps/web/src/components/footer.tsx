    ...
    <footer className="border-t border-white/10 bg-gradient-secondary">
      <div className="container grid gap-10 px-4 py-12 md:grid-cols-2 lg:grid-cols-4 lg:py-16">
        <div className="space-y-4">
          <div className="rounded-xl bg-primary/80 p-1 shadow-glow">
            <div className="rounded-lg bg-background/90 px-4 py-3">
              ...
              <p className="mt-1 text-lg font-semibold text-foreground">Complete missions. Earn cUSD.</p>
            </div>
          </div>
        ...
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-widest text-foreground/60">Explore</h3>
        ...
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-widest text-foreground/60">Resources</h3>
        ...
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-widest text-foreground/60">Stay in loop</h3>
          ...
          <div className="mt-4 flex gap-3">
            {socials.map((social) => (
              <Link
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/10 text-foreground/80 transition hover:scale-105 hover:text-foreground"
              >
      ...
      <div className="border-t border-white/10 bg-background/60">
        <div className="container flex flex-col items-center justify-between gap-4 px-4 py-6 text-xs text-foreground/50 md:flex-row">
