...
const FALLBACK_CHAIN_ID = 11142220;
const DEFAULT_CHAIN_ID = Number(process.env.NEXT_PUBLIC_DEFAULT_CHAIN_ID ?? FALLBACK_CHAIN_ID);
const FALLBACK_CONTRACTS =
  KNOWN_CONTRACTS[DEFAULT_CHAIN_ID] ?? KNOWN_CONTRACTS[FALLBACK_CHAIN_ID];
